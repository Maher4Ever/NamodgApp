...
// jQuery hashchange event - v1.3.1 - 7/21/2010 - http://benalman.com/projects/jquery-hashchange-plugin/
(function($,e,b){
...
(function (window, $, undefined) {
    ...
    Namodg = {
        ...
        handleAjaxSuccess : function (data) {
            ...
            {
                /*
                 * Sometimes when users save any of the script files with UTF-8 BOM, the json data generated from the script
                 * become not valid to jQuery's parseJSON() and it throws an error.
